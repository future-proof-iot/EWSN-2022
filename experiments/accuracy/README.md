...
- Minimal environment for running [pepper_experience](https://anonymous.4open.science/r/EWSN-pepper-D6AD/apps/pepper_experience) : 
    - Add these pythonlibs to your python path:
        - [pepper/pythonlibs](https://anonymous.4open.science/r/EWSN-pepper-D6AD/dist/pythonlibs)
...
The target application is [pepper_experience](https://anonymous.4open.science/r/EWSN-pepper-D6AD/apps/pepper_experience).

Compared to the [pepper_simple](https://anonymous.4open.science/r/EWSN-pepper-D6AD/apps/pepper_simple) application some extra modules and configurations have been added.
